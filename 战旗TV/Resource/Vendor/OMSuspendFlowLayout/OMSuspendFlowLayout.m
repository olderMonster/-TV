//
//  OMSuspendFlowLayout.m
//  header漂浮的collectionView
//
//  Created by kehwa on 16/12/26.
//  Copyright © 2016年 kehwa. All rights reserved.
//

#import "OMSuspendFlowLayout.h"

@interface OMSuspendFlowLayout()
...
@implementation OMSuspendFlowLayout
...
- (NSArray *) layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (UICollectionViewLayoutAttributes *attributes in superArray) {
        ...
        if ([attributes.representedElementKind isEqualToString:UICollectionElementKindSectionHeader])
        {
            ...
            CGFloat offset = self.collectionView.contentOffset.y + self.navigationbarH;
