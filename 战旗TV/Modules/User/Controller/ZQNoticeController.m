...
@interface ZQNoticeController ()<UITableViewDataSource , UITableViewDelegate , CTAPIManagerCallBackDelegate , CTAPIManagerInterceptor>
...
@implementation ZQNoticeController
...
- (ZQOfficialAnnouncementManager *)annouceManager{
    if (_annouceManager == nil) {
        ...
        _annouceManager.officialType = @"notice";
    }
