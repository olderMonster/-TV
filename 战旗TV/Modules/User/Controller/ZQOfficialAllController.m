...
@interface ZQOfficialAllController ()<UITableViewDataSource , UITableViewDelegate , CTAPIManagerCallBackDelegate , CTAPIManagerInterceptor>
...
@implementation ZQOfficialAllController
...
- (ZQOfficialAnnouncementManager *)annouceManager{
    if (_annouceManager == nil) {
        ...
        _annouceManager.officialType = @"all";
    }
