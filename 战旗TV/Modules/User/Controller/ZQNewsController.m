...
@interface ZQNewsController ()<UITableViewDataSource , UITableViewDelegate , CTAPIManagerCallBackDelegate , CTAPIManagerInterceptor>
...
@implementation ZQNewsController
...
- (ZQOfficialAnnouncementManager *)annouceManager{
    if (_annouceManager == nil) {
        ...
        _annouceManager.officialType = @"news";
    }
