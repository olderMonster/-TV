...
@interface ZQInterviewController ()<UITableViewDataSource , UITableViewDelegate , CTAPIManagerCallBackDelegate , CTAPIManagerInterceptor>
...
@implementation ZQInterviewController
...
- (ZQOfficialAnnouncementManager *)annouceManager{
    if (_annouceManager == nil) {
        ...
        _annouceManager.officialType = @"interview";
    }
